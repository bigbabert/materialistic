...
class SiteOrigin_Panels_Settings {
	...
	function admin_scripts($prefix){
		...
		wp_enqueue_style( 'material-at', get_template_directory(__FILE__) . '/inc/siteorigin-panels/settings/admin-settings.css', array(), NULL );
		wp_enqueue_script( 'material-at', get_template_directory(__FILE__) . '/inc/siteorigin-panels/settings/admin-settings' . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array(), NULL );
	}
