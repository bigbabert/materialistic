...
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/settings/settings.php';

// Include all the basic widgets
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/widgets/basic.php';
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/widgets/migration.php';

require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/inc/css.php';
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/inc/revisions.php';
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/inc/styles.php';
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/inc/default-styles.php';
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/inc/widgets.php';
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/inc/plugin-activation.php';
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/inc/admin-actions.php';
require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/inc/sidebars-emulator.php';

if( defined('SITEORIGIN_PANELS_DEV') && SITEORIGIN_PANELS_DEV ) include get_template_directory(__FILE__).'/inc/siteorigin-panels/inc/debug.php';
...
function siteorigin_panels_render_admin_home_page(){
	...
	include get_template_directory(__FILE__).'/inc/siteorigin-panels/tpl/admin-home-page.php';
}
...
function siteorigin_panels_metabox_render( $post ) {
	$panels_data = siteorigin_panels_get_current_admin_panels_data();
	include get_template_directory(__FILE__) . '/inc/siteorigin-panels/tpl/metabox-panels.php';
}
...
function siteorigin_panels_js_templates(){
	include get_template_directory(__FILE__).'/inc/siteorigin-panels/tpl/js-templates.php';
}
...
function siteorigin_panels_add_help_tab_content(){
	include get_template_directory(__FILE__) . '/inc/siteorigin-panels/tpl/help.php';
}
...
if( !empty($_GET['siteorigin_panels_live_editor']) ) require_once get_template_directory(__FILE__) . '/inc/siteorigin-panels/inc/live-editor.php';
