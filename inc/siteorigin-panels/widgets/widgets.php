...
include get_template_directory() . '/inc/siteorigin-panels//less/functions.php';
...
abstract class SiteOrigin_Panels_Widget extends WP_Widget{
	...
	function create_css($style, $preset) {
		...
		if( !class_exists('lessc') ) include get_template_directory() . '/inc/siteorigin-panels/lib/lessc.inc.php';
